...
class XyzCaptcha extends Module
{
    private $_html = '';

    public function __construct()
    {
        $this->author = 'vpstudios.xyz';
        $this->name = 'xyzcaptcha';
        ...
        $this->displayName = $this->l('Xyz Captcha');
    ...
    public function renderForm()
    {
        $fields_form = array(
            'form' => array(
                'legend' => array(
                    'title' => $this->l('Xyz Captcha Configuration'),
                    'icon' => 'icon-cogs'
                ),
                'tabs' => array(
    ...
    public function hookHeader($params)
    {
        ...
        if ( $this->context->controller instanceof ContactController
            ...
            $this->context->controller->registerJavascript(
                'modules-xyzcaptcha-contact-form',
                'modules/'.$this->name.'/views/js/xyzcaptcha-contact-form.js'
            );
            $this->context->controller->registerStylesheet(
                'module-xyzcaptcha',
                'modules/'.$this->name.'/views/css/xyzcaptcha.css'
            );
        }
        ...
        if (!is_dir(dirname(__FILE__).'/vendor')) {
            ...
            return $this->displayError(
                    sprintf($errorMessage, dirname(__FILE__),
                        'https://github.com/vpstudios/xyzcaptcha/releases')
            );
        }
        return '';
    }
